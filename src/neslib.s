...
cx1:			.res 1 ; collision x1
cy1:			.res 1 ; collision x2
cw1:			.res 1 ; collision w1
ch1:			.res 1 ; collision h2

cx2:			.res 1 ; collision x1
...
;*****************************************************************
; collision_test: This tests for a collision between two sprites
; cx1, cy1, cw1, ch1 - collision box for sprite 1
; cx2, cy2, cw2, ch2 - collision box for sprite 2
; sets the carry flag if there is a collision
;*****************************************************************
